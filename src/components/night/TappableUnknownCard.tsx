  ...
  return (
    ...
    >
      <div className={`w-10 h-14 bg-gray-800 rounded border flex items-center justify-center transition-all ${
        selected
          ? "border-amber-400"
          : "border-amber-400/50 shadow-[0_0_12px_rgba(212,175,55,0.3)] hover:border-amber-400 hover:shadow-[0_0_18px_rgba(212,175,55,0.5)]"
      }`}>
        <span className="material-icons text-amber-300">question_mark</span>
      </div>
      <span className="text-[9px] text-amber-300/80 mt-0.5 font-bold">???</span>
    </button>
  );
}
